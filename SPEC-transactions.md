...
This document defines the transaction layout. The signature is carried outside the transaction body, which is the wrapper requirement, with domain separation for signing.
