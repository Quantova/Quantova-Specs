# SPEC-invariants — Invariants, Threat Model & Scheme Agility
...
## Scope
Adversary model (incl. cryptographically-relevant quantum adversary), the scheme-agility mechanism, and the unrepresentability rule that binds every other spec.
