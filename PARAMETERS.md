...
Governance runs five parallel tracks and every track passes on one and the same bar. A proposal passes only when at least forty percent of the total staked QTOV votes yes, which is 4000 basis points of the staked electorate, and the same forty percent applies to every track including freeze and asset recovery. Each track carries its own refundable deposit and its own voting period. The Chain upgrades track carries a deposit of 2,250,000 QTOV and runs fourteen days, and it is the only track that may propose and enact a parameter change. The Mint QTOV track carries a deposit of 4,000,000 QTOV and runs three days. The Bridge pool migration track carries a deposit of 1,500,000 QTOV and runs five days. The Freeze and asset recovery track carries a deposit of 292,500 QTOV and ratifies in about six hours. The Blacklist and kill address track carries a deposit of 390,000 QTOV and runs about two days. The emergency bridge freeze is a bonded action rather than a vote, and its bond is 1,500,000 QTOV, returned in full to the depositor when the freeze lifts.
